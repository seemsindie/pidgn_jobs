...
- Unique job enforcement (ignore_new, cancel_existing)
- Telemetry hooks for job lifecycle events
- Queue pause/resume at runtime
- Automatic rescue of timed-out jobs
- GitHub Actions CI
